...
class SEdNode_InstantDialogueEdge : public SGraphNode
{
public:
	SLATE_BEGIN_ARGS(SEdNode_InstantDialogueEdge){}
	SLATE_END_ARGS()

	void Construct(const FArguments& InArgs, UEdNode_InstantDialogueEdge* InNode);
