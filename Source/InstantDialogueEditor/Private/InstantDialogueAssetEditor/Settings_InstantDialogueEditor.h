...
#include "Settings_InstantDialogueEditor.generated.h"
...
UCLASS()
class UInstantDialogueEditorSettings : public UObject
{
	GENERATED_BODY()

public:
	UInstantDialogueEditorSettings();
	virtual ~UInstantDialogueEditorSettings();
